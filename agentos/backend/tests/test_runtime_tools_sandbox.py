...
from agentos.backend.tools.runtime_tools import resolve_tools
from agentos.backend.tools.sandbox_runner import SandboxResult
...
def test_resolved_tools_execute_via_runtime_pipeline(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "agentos.backend.tools.runtime_tools._gateway",
